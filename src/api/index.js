...
export const getQuestions = (phone, language) =>
  API.get(`/questions?phone=${phone}&language=${language}`);
export const submitAssessment = (phone, answers) =>
  API.post("/submit-assessment", { phone, answers });
...
export const addBulkQuestions = (data) =>
